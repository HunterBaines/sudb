...
def strfboard(board, colormap=None, candidate_map=None, terminal_width=0, show_axes=False,
    ...
    ... 
    >>> print(frmt.strfboard(puzzle, candidate_map=candidates,
    ...                      terminal_width=75))
    ╔═══════════════════╦═══════════════════╦═══════════════════╗
    ║ ┌───┐ ┌───┐       ║ ┌───┐       ┌───┐ ║       ┌───┐ ┌───┐ ║
    ║ │   │ │   │       ║ │   │       │1  │ ║       │   │ │   │ ║
    ...
    ║ ┌───┐ ┌───┐       ║       ┌───┐       ║       ┌───┐ ┌───┐ ║
    ║ │  3│ │  3│       ║       │  3│       ║       │  3│ │  3│ ║
    ║ │45 │ │45 │   8   ║   1   │456│   2   ║   9   │456│ │456│ ║
    ║ │   │ │   │       ║       │   │       ║       │7  │ │7  │ ║
    ║ └───┘ └───┘       ║       └───┘       ║       └───┘ └───┘ ║
    ║       ┌───┐ ┌───┐ ║ ┌───┐ ┌───┐ ┌───┐ ║ ┌───┐ ┌───┐       ║
    ║       │123│ │   │ ║ │   │ │  3│ │   │ ║ │1  │ │1 3│       ║
    ║   7   │45 │ │4  │ ║ │45 │ │456│ │4  │ ║ │   │ │456│   8   ║
    ║       │  9│ │  9│ ║ │  9│ │  9│ │   │ ║ │   │ │   │       ║
    ║       └───┘ └───┘ ║ └───┘ └───┘ └───┘ ║ └───┘ └───┘       ║
    ║ ┌───┐ ┌───┐       ║       ┌───┐       ║       ┌───┐ ┌───┐ ║
    ║ │1 3│ │1 3│       ║       │  3│       ║       │1 3│ │  3│ ║
    ║ │45 │ │45 │   6   ║   7   │45 │   8   ║   2   │45 │ │45 │ ║
    ║ │   │ │  9│       ║       │  9│       ║       │   │ │   │ ║
    ║ └───┘ └───┘       ║       └───┘       ║       └───┘ └───┘ ║
    ╠═══════════════════╬═══════════════════╬═══════════════════╣
    ║ ┌───┐ ┌───┐       ║       ┌───┐       ║       ┌───┐ ┌───┐ ║
    ...
    ║       ┌───┐ ┌───┐ ║       ┌───┐       ║ ┌───┐ ┌───┐       ║
    ║       │1  │ │   │ ║       │   │       ║ │1  │ │1  │       ║
    ║   8   │4 6│ │4  │ ║   2   │45 │   3   ║ │   │ │4 6│   9   ║
    ║       │7  │ │7  │ ║       │7  │       ║ │7  │ │7  │       ║
    ║       └───┘ └───┘ ║       └───┘       ║ └───┘ └───┘       ║
    ║ ┌───┐ ┌───┐       ║ ┌───┐       ┌───┐ ║       ┌───┐ ┌───┐ ║
    ║ │   │ │   │       ║ │   │       │   │ ║       │ 2 │ │ 2 │ ║
    ║ │4 6│ │4 6│   5   ║ │4  │   1   │4  │ ║   3   │4 6│ │4 6│ ║
    ║ │   │ │7 9│       ║ │   │       │7  │ ║       │78 │ │7  │ ║
    ║ └───┘ └───┘       ║ └───┘       └───┘ ║       └───┘ └───┘ ║
    ╚═══════════════════╩═══════════════════╩═══════════════════╝
    <BLANKLINE>
